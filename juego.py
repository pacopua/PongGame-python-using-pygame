...
#console
font = pygame.font.Font('resources/PressStart2P-Regular.ttf', 24)
...
while left_points < 3 and right_points < 3:
    ran_list = [random.uniform(-70,-30), random.uniform(30, 70), random.uniform(-160,-120), random.uniform(120, 160)]
